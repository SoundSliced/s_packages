...
class _SContextMenuState extends State<SContextMenu> with WidgetsBindingObserver {
  ...
  Widget build(BuildContext context) {
    final childWrapped = widget.followAnchor
        ? CompositedTransformTarget(link: _layerLink, child: KeyedSubtree(key: _childKey, child: widget.child))
      ...
      children: [
        ...
        Expanded(
          child: Text(widget.label,
              overflow: TextOverflow.ellipsis, softWrap: false, style: widget.baseTextStyle.copyWith(color: textColor)),
        ),
