...
// Translation of the present-weather codes into english
  ...
  Map<String, String> weatherOther = {
    'PO': 'sand whirls',
    'SQ': 'squalls',
    'FC': 'funnel cloud',
    'SS': 'sandstorm',
  ...
  Map<String, String> weatherSpecial = {
    '+FC': 'tornado',
  };
  ...
  // 0919
  Map<String, String> runwayDeposits = {
    '0': 'clear and dry',
    '1': 'damp',
  ...
  // 0519
  Map<String, String> runwayContamination = {
    '1': 'less than 10%',
    '2': '11%-25%',
    '3': 'reserved',
    '4': 'reserved',
  ...
  // 1079
  Map<String, String> depositDepth = {
    '00': 'less than 1 mm',
    '91': 'reserved',
    '92': '10 cm',
    '93': '15 cm',
  ...
  // 0366
  Map<String, String> surfaceFriction = {
...
// Translation of various remark codes into english
  ...
  Map<String, String> pressureTendency = {
  ...
  Map<String, String> lightningFrequency = {
    'OCNL': 'occasional',
    'FRQ': 'frequent',
    'CONS': 'constant',
  };

  Map<String, String> lightningType = {
    'IC': 'intracloud',
    'CC': 'cloud-to-cloud',
    'CG': 'cloud-to-ground',
    'CA': 'cloud-to-air',
