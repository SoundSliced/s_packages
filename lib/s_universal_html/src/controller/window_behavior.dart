...
import 'package:s_packages/s_universal_html/controller.dart';
import 'package:s_packages/s_universal_html/html.dart';

import 'window_behavior_impl_browser.dart'
    if (dart.library.js_interop) 'window_behavior_impl_browser.dart' // Browser/Web
...
class WindowBehavior {
  ...
  void handleFileUploadInputElementClick(
    ...
    // No-op fallback outside browser-integrated file picker environments.
  }
