...
class _SSpreadsheetState extends State<SSpreadsheet> {
  ...
  void _configureKeystrokeFocusNode(FocusNode? provided) {
    ...
    if (_keystrokeFocusNode != null) {
      _keystrokeFocusNode!.removeListener(_onSpreadsheetFocusChanged);
    ...
    _keystrokeFocusNode!.addListener(_onSpreadsheetFocusChanged);
    debugPrint(
      '[SSpreadsheetFocus] _configureKeystrokeFocusNode — '
      'owns=$_ownsKeystrokeFocusNode debugLabel=${_keystrokeFocusNode!.debugLabel}',
    );
  }

  void _onSpreadsheetFocusChanged() {
    final fn = _keystrokeFocusNode;
    if (fn == null) return;
    debugPrint(
      '[SSpreadsheetFocus] FocusNode changed — '
      'hasFocus=${fn.hasFocus} '
      'hasPrimaryFocus=${fn.hasPrimaryFocus} '
      'canRequestFocus=${fn.canRequestFocus} '
      'debugLabel=${fn.debugLabel}',
    );
  }
